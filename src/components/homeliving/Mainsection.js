    ...
    return (
        <div>
            ...
            <div className='mens-detail'>
                {
                    hlData.map((hl) => {
                        const { img,title,discription,star,review,mrp,sp } = hl
