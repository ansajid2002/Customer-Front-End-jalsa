  ...
  return (
    <div>
      ...
      <div className="mens-checkbox">
        ...
        <label htmlFor="mens-a" >Home Decor (131)</label>
        <br />
        <input type="checkbox" id="mens-b" className="mens-box" />
        <label htmlFor="mens-b" >Vases (131)</label>
        <br />
        <input type="checkbox" id="mens-c" className="mens-box" />
        <label htmlFor="mens-c" >Kitchen & Dining (131)</label>
        <br />
        <input type="checkbox" id="mens-d" className="mens-box" />
        <label htmlFor="mens-d" >Lamps & Lightning (131)</label>
        <br />
        <input type="checkbox" id="mens-e" className="mens-box" />
        <label htmlFor="mens-e" >Festive Decor (131)</label>
        <br />
        <input type="checkbox" id="mens-f" className="mens-box" />
        <label htmlFor="mens-f" >Candles (131)</label>
