  ...
  return (
    <div>
      ...
      <div className="mens-checkbox">
        ...
        <label htmlFor="mens-a" >Bengals (131)</label>
        <br />
        <input type="checkbox" id="mens-b" className="mens-box" />
        <label htmlFor="mens-b" >Neclace (131)</label>
        <br />
        <input type="checkbox" id="mens-c" className="mens-box" />
        <label htmlFor="mens-c" >Earings (131)</label>
        <br />
        ...
        <label htmlFor="mens-e" >Footwear (131)</label>
        <br />
        <input type="checkbox" id="mens-f" className="mens-box" />
        <label htmlFor="mens-f" >Rings (131)</label>
      ...
      <div className="mens-checkbox">
        ...
        <label htmlFor="mens-i" >Bridal</label>
        <br />
        <input type="checkbox" id="mens-j" className="mens-box" />
        <label htmlFor="mens-j" >Party</label>
        <br />
        <input type="checkbox" id="mens-k" className="mens-box" />
        <label htmlFor="mens-k" >Qork</label>
        <br />
